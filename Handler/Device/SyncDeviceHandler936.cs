...
{
	public class SyncDeviceHandler936 : ISyncDeviceHandler
	{
		private static readonly object _synclock = new object();
		private static SyncDeviceHandler936 Instance;
		...
		public SyncDeviceHandler936()
		{
			
		}

		public static SyncDeviceHandler936 GetInstance()
		{
			if (Instance == null)
			{
				lock (_synclock)
				{
					if (Instance == null)
					{
						Instance = new SyncDeviceHandler936();
					}
				}
			}
